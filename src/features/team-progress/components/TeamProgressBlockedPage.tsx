...
type TeamProgressBlockedPageProps = {
  className?: string
}

export function TeamProgressBlockedPage({ className }: TeamProgressBlockedPageProps) {
  return (
      ...
      <section className="mx-auto max-w-2xl rounded-2xl border border-white/15 bg-white/8 p-6 shadow-[0_8px_32px_rgba(0,0,0,0.2)] backdrop-blur-xl sm:p-8">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-xl font-semibold text-hero-text sm:text-2xl">Progreso de Equipo</h1>
            <p className="mt-3 text-sm leading-relaxed text-hero-text/75 sm:text-base">
              Necesitas activar tu grupo para ver el progreso de tu equipo.
            </p>
