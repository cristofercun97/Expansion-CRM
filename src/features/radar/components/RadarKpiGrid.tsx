...
import type { ContactKpis } from '@/features/contacts/utils/contactKpis'

type RadarKpiGridProps = {
  kpis: ContactKpis
}

const KPI_ITEMS = [
  { key: 'total', label: 'Total de interesados', icon: Users },
...
export function RadarKpiGrid({ kpis }: RadarKpiGridProps) {
  return (
